...
This functionality is implemented in the files in the ``modules/mcuboot`` subfolder in the `ZCAN-sdk`_ repository.
...
.. _`ZCAN-sdk`: https://github.com/ZCAN-IOT/ZCAN-sdk
